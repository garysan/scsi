...
my $usuario = &validate;
my $reporte = "usuarios1.pdf";
$search=1;
my $titulo="Reporte de usuarios Activos";
...
my $page_num  = 1;
my $data =[];
my $sth = $dbh->prepare("SELECT adusrusrn,adusrnomb,adusradmn,adusrfpro,adusrflog,adusrhlog FROM adusr WHERE adusrstat=1 ") or &dberror;
...
<div id=completo>
<object
   data=\"$reporte\" width=\"100%\" height=\"100%\"navpanes=\"0\";scrollbar=\"1\"; type=\"application/pdf\">
   <p>PDF <a href=\"$reporte\">Click para descargar.</a>.
   </p>
</object>
</div>
